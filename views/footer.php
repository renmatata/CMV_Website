            ...
            <div class="row footer_row">
              ...
              <div class="col-lg-3">
                ...
                <div class="footer_list">
                  <ul>
                    <li>Mahayag Norte 6343</li>
                    <li>Catigbian Bohol</li>
                    <li>Philippines</li>
                  </ul>
                </div>
              </div>
              ...
              <div class="col-lg-3">
                ...
                <div class="footer_list">
                  <ul>
                    <li class="reservation"><a <?php if ($_GET['m'] == 'reservation') : ?> active <?php endif; ?>" aria-current="page" href="index.php?m=reservation">Book Now!</a> </li>
                    <li>Phone: +639568010758</li>
