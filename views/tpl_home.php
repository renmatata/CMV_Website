                  ...
                  <div class="row">
                    <div class="col">
                      <div class="home_content text-center">
                        <div class="home_title">Exquisite Wilderness</div>
                        <p>Just Fall Inlove With the Scenery</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="home_container">
                <div class="container">
                  <div class="row">
                    <div class="col">
                      <div class="home_content text-center">
                        <div class="home_title">An Enchanting Stay</div>
                        <p>Just Fall Inlove With the Scenery</p>
                      </div>
                    </div>
                  </div>
              ...
              <div class="home_container">
                <div class="container">
                  <div class="row">
                    <div class="col">
                      <div class="home_content text-center">
                        <div class="home_title">Majestic View</div>
                        <p>Just Fall Inlove With the Scenery</p>
                      </div>
                    </div>
                  </div>
          ...
          <div class="row">
            ...
            <div class="col-lg-3 icon_box_col">
              ...
              >
                ...
                <div class="icon_box_title"><h2>Botanical Garden</h2></div>
                <div class="icon_box_text">
                  <p>
                    Step into a vibrant oasis, where a diverse tapestry of plant
                    life awaits in a lush of botanical haven
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-3 icon_box_col">
              ...
              >
                ...
                <div class="icon_box_title"><h2>Resto Bar</h2></div>
                <div class="icon_box_text">
                  <p>
                    Induldge in delectable flavors and crafted cocktails, as our
                    resto-bar becomes a perfect blend of culinary artistry and
                    vibrant social ambiance
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-3 icon_box_col">
              ...
              >
                ...
                <div class="icon_box_title"><h2>Underground Museum</h2></div>
                <div class="icon_box_text">
                  <p>
                    Explore a hidden world of history and culture. Discover
                    artifacts that brings the past to life beneath the surface.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-3 icon_box_col">
              ...
              >
                ...
                <div class="icon_box_title"><h2>Entertainment</h2></div>
                <div class="icon_box_text">
                  <p>
                    Captivates and delights us through diverse media and
                    activities, offering enjoyment and emotionla connection
                  </p>
                </div>
              </div>
            </div>
        ...
        <div class="gallery_slider_container">
          <div class="owl-carousel owl-theme gallery_slider">
            ...
            <div class="gallery_item">
              <div
                class="background_image"
                style="background-image: url(images/gallery_1.jpg)"
              ></div>
            ...
            <div class="gallery_item">
              <div
                class="background_image"
                style="background-image: url(images/gallery_2.jpg)"
              ></div>
            ...
            <div class="gallery_item">
              <div
                class="background_image"
                style="background-image: url(images/gallery_3.jpg)"
              ></div>
            ...
            <div class="gallery_item">
              <div
                class="background_image"
                style="background-image: url(images/gallery_4.jpg)"
              ></div>
      ...
      <div class="about">
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-6">
              <div
                class="about_images d-flex flex-row align-items-center justify-content-between flex-wrap"
              >
