...
!(function (t, e) {
  ...
  var r,
    ...
    Vn =
      ...
      (Ht = "dropright"),
      (Lt = "dropleft"),
      (Rt = "dropdown-nav-right"),
      (xt = "position-static"),
      (Wt = '[data-toggle="dropdown"]'),
      (Ut = ".dropdown form"),
      (qt = ".dropdown-nav"),
      (Ft = ".navbar-nav"),
      (Kt = ".dropdown-nav .dropdown-item:not(.disabled):not(:disabled)"),
      (Mt = "top-start"),
      (Qt = "top-end"),
      (Bt = "bottom-start"),
      (Vt = "bottom-end"),
      ...
      (Gt = (function () {
        ...
        return (
          ...
          (t._getnavElement = function () {
            if (!this._nav) {
              var t = c._getParentFromElement(this._element);
              t && (this._nav = t.querySelector(qt));
            }
            return this._nav;
          }),
          (t._getPlacement = function () {
            ...
            return (
              t.hasClass(jt)
                ? ((e = Mt), bt(this._nav).hasClass(Rt) && (e = Qt))
                : t.hasClass(Ht)
                ? (e = Yt)
                : t.hasClass(Lt)
                ? (e = zt)
                : bt(this._nav).hasClass(Rt) && (e = Vt),
              e
            );
          }),
      ...
      bt(document)
        ...
        .on(Ot.CLICK_DATA_API + " " + Ot.KEYUP_DATA_API, Gt._clearnavs)
